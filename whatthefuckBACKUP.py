...
def onEnter(event):
    ...
    global lopeta
    lopeta = ImageTk.PhotoImage(Image.open(r'C:\Users\roksa\Desktop\JAMIsysky\lopeta_hover.png'))
    lopeta_nappi.config(image=lopeta)

def onEnter2(event):
    """Kun kursori menee 'uudestaan' napin päälle, kuva muuttuu tummemmaksi"""
    global uudestaan
    uudestaan = ImageTk.PhotoImage(Image.open(r'C:\Users\roksa\Desktop\JAMIsysky\uudestaan_hover.png'))
    uudestaan_nappi.config(image=uudestaan)   

def onLeave(event):
    """Kun kursori lähtee 'lopeta' napin päältä, kuva palaa entiselleen"""
    global lopeta
    lopeta = ImageTk.PhotoImage(Image.open(r'C:\Users\roksa\Desktop\JAMIsysky\lopeta1.png'))
    lopeta_nappi.config(image=lopeta)

def onLeave2(event):
    """Kun kursori lähtee 'uudestaan' napin päältä, kuva palaa entiselleen"""
    global uudestaan
    uudestaan = ImageTk.PhotoImage(Image.open(r'C:\Users\roksa\Desktop\JAMIsysky\uudestaan1.png'))
    uudestaan_nappi.config(image=uudestaan)
...
peli_kuva1 = r"C:\Users\roksa\Desktop\JAMIsysky\not_pressed.png"
peli_kuva2 = r"C:\Users\roksa\Desktop\JAMIsysky\hover.png"
